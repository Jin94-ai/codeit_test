...
def write_data_yaml(yolo_root: str, categories_df: pd.DataFrame, unique_cat_ids: list):
    ...
    # --- pills.yaml 내용에 custom_dataset_class와 augmentation_pipeline_choice를 추가 ---
    custom_dataset_path = "src.data.yolo_dataset.pill_yolo_dataset.PillYoloDataset"
...
# --- Albumentations 연동을 위한 커스텀 데이터셋 설정 ---
# 모델이 이 경로의 클래스를 사용하여 데이터를 로드하고 증강을 적용.
custom_dataset_class: {custom_dataset_path}
# 사용될 증강 파이프라인
augmentation_pipeline_choice: conservative
"""
